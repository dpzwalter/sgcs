/*
       ...
       Generated on: 8/23/2020 14:32:30.89
...
namespace GeneXus.Programs {
   public class dashboard : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202082314323090", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         if ( context.isAjaxRequest( ) )
         {
            context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "vCURRENTEVENT", AV8currentEvent);
         }
         else
         {
            context.httpAjaxContext.ajax_rsp_assign_hidden_sdt("vCURRENTEVENT", AV8currentEvent);
         }
         GxWebStd.gx_hidden_field( context, "vINITIALDATE", context.localUtil.DToC( AV9initialDate, 0, "/"));
      }
      ...
      protected void WB3M0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            ucGxscheduler1.SetProperty("CurrentEvent", AV8currentEvent);
            ucGxscheduler1.SetProperty("InitialDate", AV9initialDate);
      ...
      protected void STRUP3M0( )
      {
         ...
         {
            /* Read saved SDTs. */
            ajax_req_read_hidden_sdt(cgiGet( "vCURRENTEVENT"), AV8currentEvent);
            /* Read saved values. */
            AV9initialDate = context.localUtil.CToD( cgiGet( "vINITIALDATE"), 0);
      ...
      protected void E113M2( )
      {
         ...
         AV10websession.Set("currentevent", AV8currentEvent.ToXml(false, true, "", ""));
      }
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("dashboard.js", "?202082314323096", false, true);
         context.AddJavascriptSource("GXScheduler/dhtmlxscheduler.js", "", false, true);
         context.AddJavascriptSource("GXScheduler/GXSchedulerRender.js", "", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GXSCHEDULER1.EVENTSELECTED","{handler:'E113M2',iparms:[{av:'AV8currentEvent',fld:'vCURRENTEVENT',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         bodyStyle = "";
         GXKey = "";
         AV8currentEvent = new SdtSchedulerEvents_event(context);
         AV9initialDate = DateTime.MinValue;
         GX_FocusControl = "";
         Form = new GXWebForm();
         sPrefix = "";
         ucGxscheduler1 = new GXUserControl();
         sEvt = "";
         EvtGridId = "";
         EvtRowId = "";
         sEvtType = "";
      ...
      private DateTime AV9initialDate ;
      ...
      private GXUserControl ucGxscheduler1 ;
      ...
      private SdtSchedulerEvents_event AV8currentEvent ;
   }
