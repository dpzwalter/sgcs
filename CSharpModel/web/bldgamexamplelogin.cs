...
using System.IO;
public class bldgamexamplelogin : GxBaseBuilder
{
   string cs_path = "." ;
   public bldgamexamplelogin( ) : base()
   {
   }
   ...
   {
      bldgamexamplelogin x = new bldgamexamplelogin() ;
      x.SetMainSourceFile( "gamexamplelogin.cs");
