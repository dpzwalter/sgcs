...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="DashboardViewerValuesHighlightedData.Element" , Namespace="SGCS" )]
	[Serializable]
	...
	[DataContract(Name=@"DashboardViewerValuesHighlightedData.Element", Namespace="SGCS")]
