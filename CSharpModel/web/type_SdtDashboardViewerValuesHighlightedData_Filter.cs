...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="DashboardViewerValuesHighlightedData.Filter" , Namespace="SGCS" )]
	[Serializable]
	...
	[DataContract(Name=@"DashboardViewerValuesHighlightedData.Filter", Namespace="SGCS")]
