/*
       ...
       Generated on: 8/23/2020 14:32:29.44
...
namespace GeneXus.Programs {
   public class rwdmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm042( )
      {
         ...
         context.AddJavascriptSource("rwdmasterpage.js", "?202082314322945", false, true);
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblApplicationheader_Internalname, "SGCS Software Configuration Manager", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlockHeader", 0, "", 1, 1, 0, "HLP_RwdMasterPage.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttEnter_Internalname, "", "Home", bttEnter_Jsonclick, 7, "Home", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e11041_client"+"'", TempTags, "", 2, "HLP_RwdMasterPage.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            if ( ! isFullAjaxMode( ) )
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "MPW0019"+"", StringUtil.RTrim( WebComp_Wcrecentlinks_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
               context.WriteHtmlText( " id=\""+"gxHTMLWrpMPW0019"+""+"\""+"") ;
               context.WriteHtmlText( ">") ;
               if ( StringUtil.StrCmp(StringUtil.Lower( OldWcrecentlinks), StringUtil.Lower( WebComp_Wcrecentlinks_Component)) != 0 )
               {
                  context.httpAjaxContext.ajax_rspStartCmp("gxHTMLWrpMPW0019"+"");
               }
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "M") == 0 )
                  {
                     ...
                     if ( nCmpId == 19 )
                     {
                        OldWcrecentlinks = cgiGet( "MPW0019");
                        ...
                        WebComp_Wcrecentlinks.componentprocess("MPW0019", "", sEvt);
                        WebComp_Wcrecentlinks_Component = OldWcrecentlinks;
                     }
                  }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?202082314322950", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("rwdmasterpage.js", "?202082314322950", false, true);
      ...
      protected void init_default_properties( )
      {
         ...
         bttEnter_Internalname = "ENTER_MPAGE";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("HOME_MPAGE","{handler:'E11041',iparms:[]");
         setEventMetadata("HOME_MPAGE",",oparms:[]}");
         return  ;
      }
