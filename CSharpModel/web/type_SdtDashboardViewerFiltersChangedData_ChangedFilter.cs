...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="DashboardViewerFiltersChangedData.ChangedFilter" , Namespace="SGCS" )]
	[Serializable]
	...
	[DataContract(Name=@"DashboardViewerFiltersChangedData.ChangedFilter", Namespace="SGCS")]
