/*
       ...
       Generated on: 4/15/2020 11:7:22.16
...
namespace GeneXus.Programs {
   public class gamexamplewwrolepermissions : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridww") == 0 )
            {
               ...
               gxgrGridww_refresh( AV26RoleId, AV8ApplicationId, AV14FilName, AV28SearchFilter, AV24PermissionAccessType, AV9BoolenFilter) ;
            ...
            if ( ! entryPointCalled && ! ( isAjaxCallMode( ) || isFullAjaxMode( ) ) )
            {
               ...
               AssignAttri("", false, "AV26RoleId", StringUtil.LTrimStr( (decimal)(AV26RoleId), 12, 0));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20204151172268", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamexamplewwrolepermissions.aspx") + "?" + UrlEncode("" +AV26RoleId) + "," + UrlEncode("" +AV22pApplicationId)+"\">") ;
      ...
      {
         return formatLink("gamexamplewwrolepermissions.aspx") + "?" + UrlEncode("" +AV26RoleId) + "," + UrlEncode("" +AV22pApplicationId) ;
      }
      ...
      protected void WB1E0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttHide_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(66), 2, 0)+","+"null"+");", bttHide_Caption, bttHide_Jsonclick, 7, "HIDE FILTERS", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e111e1_client"+"'", TempTags, "", 2, "HLP_GAMExampleWWRolePermissions.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock4_Internalname, "Role Permissions", "", "", lblTextblock4_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, "HLP_GAMExampleWWRolePermissions.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnback_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(66), 2, 0)+","+"null"+");", "BACK", bttBtnback_Jsonclick, 1, "BACK", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleWWRolePermissions.htm");
            ...
            ClassString = "BtnBack";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnsave_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(66), 2, 0)+","+"null"+");", "Save", bttBtnsave_Jsonclick, 5, "Save", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'SAVE\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleWWRolePermissions.htm");
            GxWebStd.gx_div_end( context, "Right", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-4", "Right", "top", "", "", "div");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAddnew_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(66), 2, 0)+","+"null"+");", "Add", bttAddnew_Jsonclick, 7, "Add", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e121e1_client"+"'", TempTags, "", 2, "HLP_GAMExampleWWRolePermissions.htm");
            GxWebStd.gx_div_end( context, "Right", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "Right", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "ACCESS TYPE", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "FilterLabel", 0, "", 1, 1, 0, "HLP_GAMExampleWWRolePermissions.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "IS INHERITED?", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "FilterLabel", 0, "", 1, 1, 0, "HLP_GAMExampleWWRolePermissions.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtavCtlname1_Internalname, "ROLE", "col-xs-6 col-sm-3 SubtitleAttributeLabel", 1, true);
            /* Div Control */
            ...
            ClassString = "SubtitleAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavCtlname1_Internalname, StringUtil.RTrim( AV15GAMRole.gxTpr_Name), "", "", 0, 1, edtavCtlname1_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "254", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_GAMExampleWWRolePermissions.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavApplicationid, cmbavApplicationid_Internalname, StringUtil.Trim( StringUtil.Str( (decimal)(AV8ApplicationId), 12, 0)), 1, cmbavApplicationid_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "int", "", 1, cmbavApplicationid.Enabled, 0, 0, 0, "em", 0, "", "", "SubtitleAttribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,60);\"", "", true, "HLP_GAMExampleWWRolePermissions.htm");
      ...
      protected void gxgrGridww_refresh( long AV26RoleId ,
      ...
      protected void STRUP1E0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV26RoleId = (long)(context.localUtil.CToN( cgiGet( "vROLEID"), ".", ","));
            ...
            AssignAttri("", false, "AV9BoolenFilter", AV9BoolenFilter);
            AV15GAMRole.gxTpr_Name = cgiGet( edtavCtlname1_Internalname);
      ...
      protected void E141E2( )
      {
         ...
         AV33GXV3 = 1;
         AV32GXV2 = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV7ApplicationFilter, out  AV13Errors);
         while ( AV33GXV3 <= AV32GXV2.Count )
         {
            AV6Application = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV32GXV2.Item(AV33GXV3));
      ...
      private void E151E2( )
      {
         ...
         {
            AV27RolePermissionFilter.gxTpr_Name = "%"+AV28SearchFilter;
         }
         AV27RolePermissionFilter.gxTpr_Accesstype = AV24PermissionAccessType;
         AV27RolePermissionFilter.gxTpr_Inherited = AV9BoolenFilter;
         if ( ! (0==AV8ApplicationId) )
         {
            AV35GXV5 = 1;
            AV34GXV4 = AV15GAMRole.getpermissions(AV27RolePermissionFilter, out  AV13Errors);
            while ( AV35GXV5 <= AV34GXV4.Count )
            {
               AV23Permission = ((GeneXus.Programs.genexussecurity.SdtGAMPermission)AV34GXV4.Item(AV35GXV5));
               AV10BtnDlt = "Delete";
               AssignAttri("", false, edtavBtndlt_Internalname, AV10BtnDlt);
      ...
      protected void E131E2( )
      {
         ...
         while ( nGXsfl_66_fel_idx < nRC_GXsfl_66 )
         {
            ...
            if ( ( StringUtil.StrCmp(AV5AccessType, AV20old_AccessType) != 0 ) || ( AV17Inherited != AV21old_Inherited ) )
            {
               ...
               {
                  AV37GXV6 = 1;
                  while ( AV37GXV6 <= AV13Errors.Count )
                  {
                     AV12Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV13Errors.Item(AV37GXV6));
         ...
         if ( AV18isOK )
         {
            context.CommitDataStores("gamexamplewwrolepermissions",pr_default);
            GX_msglist.addItem("Changes saved successfully.");
         }
         else
         {
            AV38GXV7 = 1;
            while ( AV38GXV7 <= AV13Errors.Count )
            {
               AV12Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV13Errors.Item(AV38GXV7));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV12Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV12Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void E161E2( )
      {
         ...
         {
            AV39GXV8 = 1;
            while ( AV39GXV8 <= AV13Errors.Count )
            {
               AV12Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV13Errors.Item(AV39GXV8));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV12Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV12Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
               AV39GXV8 = (int)(AV39GXV8+1);
            }
         }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20204151174019", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplewwrolepermissions.js", "?20204151174022", false, true);
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV32GXV2 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplication", "GeneXus.Programs");
         ...
         AV27RolePermissionFilter = new GeneXus.Programs.genexussecurity.SdtGAMPermissionFilter(context);
         AV34GXV4 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMPermission>( context, "GeneXus.Programs.genexussecurity.SdtGAMPermission", "GeneXus.Programs");
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.gamexamplewwrolepermissions__gam(),
            new Object[][] {
            }
         );
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication> AV32GXV2 ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMError> AV13Errors ;
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMPermission> AV34GXV4 ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMPermissionFilter AV27RolePermissionFilter ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter AV7ApplicationFilter ;
   }

   public class gamexamplewwrolepermissions__gam : DataStoreHelperBase, IDataStoreHelper
   {
