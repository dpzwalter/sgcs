/*
               File: GAMExampleUserPermissionSelect
        Description: GAMExample User Permission Select
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 4/15/2020 11:11:17.39
...
namespace GeneXus.Programs {
   public class gamexampleuserpermissionselect : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gamexampleuserpermissionselect( )
      {
      ...
      public gamexampleuserpermissionselect( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Gridww") == 0 )
            {
               ...
               gxgrGridww_refresh( AV28UserId, AV7ApplicationId, AV25Search, AV26SearchFilter, AV20PermissionAccessType, AV8BoolenFilter, AV10CurrentPage) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202041511111765", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamexampleuserpermissionselect.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV28UserId)) + "," + UrlEncode("" +AV7ApplicationId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCURRENTPAGE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10CurrentPage), 4, 0, ".", "")));
      ...
      {
         return formatLink("gamexampleuserpermissionselect.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV28UserId)) + "," + UrlEncode("" +AV7ApplicationId) ;
      }

      public override String GetPgmname( )
      {
         return "GAMExampleUserPermissionSelect" ;
      }

      public override String GetPgmdesc( )
      {
         return "GAMExample User Permission Select" ;
      }
      ...
      protected void WB2K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttHide_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(71), 2, 0)+","+"null"+");", bttHide_Caption, bttHide_Jsonclick, 7, "HIDE FILTERS", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e112k1_client"+"'", TempTags, "", 2, "HLP_GAMExampleUserPermissionSelect.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock3_Internalname, "Add Permission", "", "", lblTextblock3_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBack_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(71), 2, 0)+","+"null"+");", "Back", bttBack_Jsonclick, 1, "Back", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleUserPermissionSelect.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAddselected_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(71), 2, 0)+","+"null"+");", "Add Selected", bttAddselected_Jsonclick, 5, "Add Selected", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'ADDSELECTED\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "Right", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "Right", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "DEFAULT ACCESS TYPE", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "FilterLabel", 0, "", 1, 1, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavPermissionaccesstype, cmbavPermissionaccesstype_Internalname, StringUtil.RTrim( AV20PermissionAccessType), 1, cmbavPermissionaccesstype_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavPermissionaccesstype.Enabled, 0, 0, 0, "em", 0, "", "", "FilterComboAttribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,44);\"", "", true, "HLP_GAMExampleUserPermissionSelect.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock2_Internalname, "IS INHERITED?", "", "", lblTextblock2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "FilterLabel", 0, "", 1, 1, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            /* ComboBox */
            GxWebStd.gx_combobox_ctrl1( context, cmbavBoolenfilter, cmbavBoolenfilter_Internalname, StringUtil.RTrim( AV8BoolenFilter), 1, cmbavBoolenfilter_Jsonclick, 0, "'"+""+"'"+",false,"+"'"+""+"'", "char", "", 1, cmbavBoolenfilter.Enabled, 0, 0, 0, "em", 0, "", "", "FilterComboAttribute", "", "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,54);\"", "", true, "HLP_GAMExampleUserPermissionSelect.htm");
            cmbavBoolenfilter.CurrentValue = StringUtil.RTrim( AV8BoolenFilter);
            ...
            ClassString = "SubtitleAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavCtlname_Internalname, StringUtil.RTrim( AV14GAMApplication.gxTpr_Name), "", "", 0, 1, edtavCtlname_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "254", -1, 0, "", "", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            ...
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 65,'',false,'" + sGXsfl_71_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavGamusername_Internalname, AV30GAMUserName, StringUtil.RTrim( context.localUtil.Format( AV30GAMUserName, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,65);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavGamusername_Jsonclick, 0, "SubtitleAttribute", "", "", "", "", 1, edtavGamusername_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridwwContainer.AddColumnProperties(GridwwColumn);
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridwwColumn.AddObjectProperty("Value", StringUtil.RTrim( AV5Access));
               GridwwContainer.AddColumnProperties(GridwwColumn);
               GridwwColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 71 )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbfirst_Internalname, "FIRST", "", "", lblTbfirst_Jsonclick, "'"+""+"'"+",false,"+"'"+"e122k1_client"+"'", "", lblTbfirst_Class, 7, "", 1, lblTbfirst_Enabled, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-2", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTb1_Internalname, "/", "", "", lblTb1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SelectedPagingText TextLikeLink", 0, "", 1, 1, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-2 col-sm-3", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbprev_Internalname, "PREV", "", "", lblTbprev_Jsonclick, "'"+""+"'"+",false,"+"'"+"e132k1_client"+"'", "", lblTbprev_Class, 7, "", 1, lblTbprev_Enabled, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-2", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTb2_Internalname, "/", "", "", lblTb2_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SelectedPagingText TextLikeLink", 0, "", 1, 1, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-2", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbnext_Internalname, "NEXT", "", "", lblTbnext_Jsonclick, "'"+""+"'"+",false,"+"'"+"e142k1_client"+"'", "", lblTbnext_Class, 7, "", 1, 1, 0, "HLP_GAMExampleUserPermissionSelect.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
      ...
      protected void START2K2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "GAMExample User Permission Select", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void fix_multi_value_controls( )
      {
         ...
         {
            AV8BoolenFilter = cmbavBoolenfilter.getValidValue(AV8BoolenFilter);
            AssignAttri("", false, "AV8BoolenFilter", AV8BoolenFilter);
         }
         if ( context.isAjaxRequest( ) )
         {
            cmbavBoolenfilter.CurrentValue = StringUtil.RTrim( AV8BoolenFilter);
      ...
      protected void STRUP2K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV10CurrentPage = (short)(context.localUtil.CToN( cgiGet( "vCURRENTPAGE"), ".", ","));
            ...
            AV8BoolenFilter = cgiGet( cmbavBoolenfilter_Internalname);
            AssignAttri("", false, "AV8BoolenFilter", AV8BoolenFilter);
            AV14GAMApplication.gxTpr_Name = cgiGet( edtavCtlname_Internalname);
            AV30GAMUserName = cgiGet( edtavGamusername_Internalname);
            AssignAttri("", false, "AV30GAMUserName", AV30GAMUserName);
      ...
      {
         /* Start Routine */
         if ( String.IsNullOrEmpty(StringUtil.RTrim( AV28UserId)) || (0==AV7ApplicationId) )
         {
            context.setWebReturnParms(new Object[] {(String)AV28UserId,(long)AV7ApplicationId});
            context.setWebReturnParmsMetadata(new Object[] {"AV28UserId","AV7ApplicationId"});
      ...
      {
         /* Gridww_Load Routine */
         AV9CountPermissions = 0;
         AV23PermissionsXPage = 10;
         AV29GAMUser.load( AV28UserId);
         AssignAttri("", false, "AV28UserId", AV28UserId);
         AV30GAMUserName = AV29GAMUser.gxTpr_Name;
         AssignAttri("", false, "AV30GAMUserName", AV30GAMUserName);
         AV14GAMApplication.load( AV7ApplicationId);
         AssignAttri("", false, "AV7ApplicationId", StringUtil.LTrimStr( (decimal)(AV7ApplicationId), 12, 0));
         AV22PermissionFilter.gxTpr_Applicationid = AV7ApplicationId;
         ...
         AV22PermissionFilter.gxTpr_Inherited = AV8BoolenFilter;
         AV22PermissionFilter.gxTpr_Limit = AV23PermissionsXPage;
         AV22PermissionFilter.gxTpr_Start = (int)((AV10CurrentPage-1)*AV22PermissionFilter.gxTpr_Limit+1);
         if ( ! (0==AV7ApplicationId) )
         {
            AV35GXV3 = 1;
            AV34GXV2 = AV29GAMUser.getunassignedpermissions(AV22PermissionFilter, out  AV13Errors);
            while ( AV35GXV3 <= AV34GXV2.Count )
            {
               AV19Permission = ((GeneXus.Programs.genexussecurity.SdtGAMPermission)AV34GXV2.Item(AV35GXV3));
               AV9CountPermissions = (long)(AV9CountPermissions+1);
               AV16Id = AV19Permission.gxTpr_Guid;
               AssignAttri("", false, edtavId_Internalname, AV16Id);
               AV18Name = AV19Permission.gxTpr_Name;
               AssignAttri("", false, edtavName_Internalname, AV18Name);
               AV11Dsc = AV19Permission.gxTpr_Description;
               AssignAttri("", false, edtavDsc_Internalname, AV11Dsc);
               /* Load Method */
               if ( wbStart != -1 )
               {
         ...
         if ( AV9CountPermissions < AV23PermissionsXPage )
         {
         ...
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri("", false, "AV14GAMApplication", AV14GAMApplication);
      ...
      protected void E152K2( )
      {
         ...
         while ( nGXsfl_71_fel_idx < nRC_GXsfl_71 )
         {
            ...
            if ( AV27Select )
            {
               AV21PermissionAdd.gxTpr_Applicationid = AV7ApplicationId;
               AV21PermissionAdd.gxTpr_Guid = AV16Id;
               AV21PermissionAdd.gxTpr_Type = AV5Access;
               AV17isOK = AV29GAMUser.addpermission(AV21PermissionAdd, out  AV13Errors);
               AssignAttri("", false, "AV17isOK", AV17isOK);
               if ( ! AV17isOK )
               {
                  AV37GXV4 = 1;
                  while ( AV37GXV4 <= AV13Errors.Count )
                  {
                     AV12Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV13Errors.Item(AV37GXV4));
         ...
         if ( AV17isOK )
         {
            context.CommitDataStores("gamexampleuserpermissionselect",pr_default);
            CallWebObject(formatLink("gamexamplewwuserpermissions.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV28UserId)) + "," + UrlEncode("" +AV7ApplicationId));
            context.wjLocDisableFrm = 1;
         }
         else
         {
            AV38GXV5 = 1;
            while ( AV38GXV5 <= AV13Errors.Count )
            {
               AV12Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV13Errors.Item(AV38GXV5));
               GX_msglist.addItem(StringUtil.Format( "%1 (GAM%2)", AV12Error.gxTpr_Message, StringUtil.LTrimStr( (decimal)(AV12Error.gxTpr_Code), 12, 0), "", "", "", "", "", "", ""));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202041511112425", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexampleuserpermissionselect.js", "?202041511112426", false, true);
      ...
      protected void sendrow_712( )
      {
         ...
         ROClassString = "Attribute";
         GridwwRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavAppid_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6AppId), 12, 0, ".", "")),((edtavAppid_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV6AppId), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV6AppId), "ZZZZZZZZZZZ9")),TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+((edtavAppid_Enabled!=0)&&(edtavAppid_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,76);\"" : " "),(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtavAppid_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"",(String)"",(short)0,(int)edtavAppid_Enabled,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)12,(short)0,(short)0,(short)71,(short)1,(short)-1,(short)0,(bool)true,(String)"GeneXusSecurityCommon\\GAMKeyNumLong",(String)"right",(bool)false,(String)""});
         /* Subfile cell */
         if ( GridwwContainer.GetWrapped() == 1 )
         {
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "GAMExample User Permission Select";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV28UserId',fld:'vUSERID',pic:''},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV25Search',fld:'vSEARCH',pic:''},{av:'AV26SearchFilter',fld:'vSEARCHFILTER',pic:''},{av:'cmbavPermissionaccesstype'},{av:'AV20PermissionAccessType',fld:'vPERMISSIONACCESSTYPE',pic:''},{av:'cmbavBoolenfilter'},{av:'AV8BoolenFilter',fld:'vBOOLENFILTER',pic:''},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRIDWW.LOAD","{handler:'E172K2',iparms:[{av:'AV28UserId',fld:'vUSERID',pic:''},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV25Search',fld:'vSEARCH',pic:''},{av:'AV26SearchFilter',fld:'vSEARCHFILTER',pic:''},{av:'cmbavPermissionaccesstype'},{av:'AV20PermissionAccessType',fld:'vPERMISSIONACCESSTYPE',pic:''},{av:'cmbavBoolenfilter'},{av:'AV8BoolenFilter',fld:'vBOOLENFILTER',pic:''},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZ9'}]");
         setEventMetadata("GRIDWW.LOAD",",oparms:[{av:'AV30GAMUserName',fld:'vGAMUSERNAME',pic:''},{av:'AV16Id',fld:'vID',pic:''},{av:'AV18Name',fld:'vNAME',pic:''},{av:'AV11Dsc',fld:'vDSC',pic:''},{av:'lblTbnext_Class',ctrl:'TBNEXT',prop:'Class'}]}");
         setEventMetadata("'ADDSELECTED'","{handler:'E152K2',iparms:[{av:'AV28UserId',fld:'vUSERID',pic:''},{av:'AV27Select',fld:'vSELECT',grid:71,pic:''},{av:'GRIDWW_nFirstRecordOnPage'},{av:'nRC_GXsfl_71',ctrl:'GRIDWW',grid:71,prop:'GridRC'},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV16Id',fld:'vID',grid:71,pic:''},{av:'AV5Access',fld:'vACCESS',grid:71,pic:''},{av:'AV17isOK',fld:'vISOK',pic:''}]");
         setEventMetadata("'ADDSELECTED'",",oparms:[{av:'AV17isOK',fld:'vISOK',pic:''},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV28UserId',fld:'vUSERID',pic:''}]}");
         setEventMetadata("'HIDE'","{handler:'E112K1',iparms:[{av:'divFilterscontainer_Class',ctrl:'FILTERSCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("VNAME.CLICK","{handler:'E182K2',iparms:[{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV16Id',fld:'vID',pic:''}]");
         setEventMetadata("VNAME.CLICK",",oparms:[{av:'AV16Id',fld:'vID',pic:''},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("'FIRST'","{handler:'E122K1',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV28UserId',fld:'vUSERID',pic:''},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV25Search',fld:'vSEARCH',pic:''},{av:'AV26SearchFilter',fld:'vSEARCHFILTER',pic:''},{av:'cmbavPermissionaccesstype'},{av:'AV20PermissionAccessType',fld:'vPERMISSIONACCESSTYPE',pic:''},{av:'cmbavBoolenfilter'},{av:'AV8BoolenFilter',fld:'vBOOLENFILTER',pic:''},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'PREVIOUS'","{handler:'E132K1',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV28UserId',fld:'vUSERID',pic:''},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV25Search',fld:'vSEARCH',pic:''},{av:'AV26SearchFilter',fld:'vSEARCHFILTER',pic:''},{av:'cmbavPermissionaccesstype'},{av:'AV20PermissionAccessType',fld:'vPERMISSIONACCESSTYPE',pic:''},{av:'cmbavBoolenfilter'},{av:'AV8BoolenFilter',fld:'vBOOLENFILTER',pic:''},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZ9'}]");
         ...
         setEventMetadata("'NEXT'","{handler:'E142K1',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV28UserId',fld:'vUSERID',pic:''},{av:'AV7ApplicationId',fld:'vAPPLICATIONID',pic:'ZZZZZZZZZZZ9'},{av:'AV25Search',fld:'vSEARCH',pic:''},{av:'AV26SearchFilter',fld:'vSEARCHFILTER',pic:''},{av:'cmbavPermissionaccesstype'},{av:'AV20PermissionAccessType',fld:'vPERMISSIONACCESSTYPE',pic:''},{av:'cmbavBoolenfilter'},{av:'AV8BoolenFilter',fld:'vBOOLENFILTER',pic:''},{av:'AV10CurrentPage',fld:'vCURRENTPAGE',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         AV14GAMApplication = new GeneXus.Programs.genexussecurity.SdtGAMApplication(context);
         AV30GAMUserName = "";
         ...
         AV34GXV2 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMPermission>( context, "GeneXus.Programs.genexussecurity.SdtGAMPermission", "GeneXus.Programs");
         ...
         GXCCtl = "";
         ROClassString = "";
         pr_gam = new DataStoreProvider(context, new GeneXus.Programs.gamexampleuserpermissionselect__gam(),
            new Object[][] {
            }
         );
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gamexampleuserpermissionselect__default(),
            new Object[][] {
            }
         );
         /* GeneXus formulas. */
      ...
      private long AV9CountPermissions ;
      ...
      private String AV8BoolenFilter ;
      ...
      private String AV30GAMUserName ;
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMPermission> AV34GXV2 ;
      private GXWebForm Form ;
      private GeneXus.Programs.genexussecurity.SdtGAMError AV12Error ;
      private GeneXus.Programs.genexussecurity.SdtGAMApplication AV14GAMApplication ;
   ...
   public class gamexampleuserpermissionselect__gam : DataStoreHelperBase, IDataStoreHelper
   {
 ...
 public class gamexampleuserpermissionselect__default : DataStoreHelperBase, IDataStoreHelper
 {
    public ICursor[] getCursors( )
    {
       cursorDefinitions();
