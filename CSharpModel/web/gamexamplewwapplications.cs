/*
               File: GAMExampleWWApplications
        Description: Applications
             Author: GeneXus C# Generator version 16_0_7-138086
       Generated on: 4/15/2020 11:9:40.32
...
namespace GeneXus.Programs {
   public class gamexamplewwapplications : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public gamexamplewwapplications( )
      {
      ...
      public gamexamplewwapplications( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20204151194063", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gamexamplewwapplications.aspx") +"\">") ;
      ...
      {
         return formatLink("gamexamplewwapplications.aspx")  ;
      }

      public override String GetPgmname( )
      {
         return "GAMExampleWWApplications" ;
      }
      ...
      protected void WB210( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTextblock1_Internalname, "Applications", "", "", lblTextblock1_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "Title", 0, "", 1, 1, 0, "HLP_GAMExampleWWApplications.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttAddnew1_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(23), 2, 0)+","+"null"+");", "Add", bttAddnew1_Jsonclick, 5, "Add", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'ADDNEW\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_GAMExampleWWApplications.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtavSearch_Internalname, AV12Search, StringUtil.RTrim( context.localUtil.Format( AV12Search, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,14);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Try a Search", edtavSearch_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavSearch_Enabled, 0, "text", "", 80, "chr", 1, "row", 100, 0, 0, 0, 1, 0, 0, true, "GeneXusSecurityCommon\\GAMUserIdentification", "left", true, "", "HLP_GAMExampleWWApplications.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-10 col-sm-offset-1 col-lg-8 col-lg-offset-2", "Center", "top", "", "", "div");
            /* Div Control */
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "GRIDWW.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "VNAME.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VBTNUPD.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 11), "VNAME.CLICK") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 13), "VBTNUPD.CLICK") == 0 ) )
                           {
                              ...
                              AssignAttri("", false, edtavName_Internalname, AV11Name);
      ...
      protected void gxgrGridww_refresh( String AV12Search )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void STRUP210( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV12Search = cgiGet( edtavSearch_Internalname);
            AssignAttri("", false, "AV12Search", AV12Search);
      ...
      {
         /* Gridww_Load Routine */
         AV8Filter.gxTpr_Name = "%"+AV12Search;
         AV16GXV2 = 1;
         AV15GXV1 = new GeneXus.Programs.genexussecurity.SdtGAMRepository(context).getapplications(AV8Filter, out  AV7Errors);
         while ( AV16GXV2 <= AV15GXV1.Count )
         {
            AV5Application = ((GeneXus.Programs.genexussecurity.SdtGAMApplication)AV15GXV1.Item(AV16GXV2));
            AV6BtnUpd = "EDIT";
            AssignAttri("", false, edtavBtnupd_Internalname, AV6BtnUpd);
            ...
            AssignAttri("", false, edtavName_Internalname, AV11Name);
            if ( (DateTime.MinValue==AV5Application.gxTpr_Clientrevoked) )
            {
      ...
      {
         /* 'AddNew' Routine */
         CallWebObject(formatLink("gamexampleapplicationentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("INS")) + "," + UrlEncode("" +0));
      ...
      {
         /* Name_Click Routine */
         CallWebObject(formatLink("gamexampleapplicationentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("DSP")) + "," + UrlEncode("" +AV10Id));
         context.wjLocDisableFrm = 1;
         context.DoAjaxRefresh();
         /*  Sending Event outputs  */
      }
      ...
      protected void E14212( )
      {
         ...
         CallWebObject(formatLink("gamexampleapplicationentry.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +AV10Id));
         context.wjLocDisableFrm = 1;
         context.DoAjaxRefresh();
         /*  Sending Event outputs  */
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20204151194464", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("gamexamplewwapplications.js", "?20204151194467", false, true);
         }
      ...
      protected void sendrow_232( )
      {
         ...
         /* Single line edit */
         TempTags = " " + ((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 26,'',false,'"+sGXsfl_23_idx+"',23)\"" : " ");
         ROClassString = "Attribute";
         GridwwRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtavId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(AV10Id), 12, 0, ".", "")),((edtavId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(AV10Id), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(AV10Id), "ZZZZZZZZZZZ9")),TempTags+" onchange=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onchange(this, event)\" "+((edtavId_Enabled!=0)&&(edtavId_Visible!=0) ? " onblur=\""+"gx.num.valid_integer( this,',');"+";gx.evt.onblur(this,26);\"" : " "),(String)"'"+""+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtavId_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"",(String)"",(short)0,(int)edtavId_Enabled,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)12,(short)0,(short)0,(short)23,(short)1,(short)-1,(short)0,(bool)true,(String)"GeneXusSecurityCommon\\GAMKeyNumLong",(String)"right",(bool)false,(String)""});
      ...
      public override void initialize_properties( )
      {
         ...
         edtavName_Enabled = 1;
         edtavName_Class = "Attribute TextLikeLink SmallLink";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV12Search',fld:'vSEARCH',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRIDWW.LOAD","{handler:'E12212',iparms:[{av:'AV12Search',fld:'vSEARCH',pic:''}]");
         setEventMetadata("GRIDWW.LOAD",",oparms:[{av:'AV6BtnUpd',fld:'vBTNUPD',pic:''},{av:'AV10Id',fld:'vID',pic:'ZZZZZZZZZZZ9'},{av:'AV11Name',fld:'vNAME',pic:''},{av:'edtavName_Class',ctrl:'vNAME',prop:'Class'}]}");
         setEventMetadata("'ADDNEW'","{handler:'E11212',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV12Search',fld:'vSEARCH',pic:''}]");
         setEventMetadata("'ADDNEW'",",oparms:[]}");
         setEventMetadata("VNAME.CLICK","{handler:'E13212',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV12Search',fld:'vSEARCH',pic:''},{av:'AV10Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("VNAME.CLICK",",oparms:[{av:'AV10Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("VBTNUPD.CLICK","{handler:'E14212',iparms:[{av:'GRIDWW_nFirstRecordOnPage'},{av:'GRIDWW_nEOF'},{av:'AV12Search',fld:'vSEARCH',pic:''},{av:'AV10Id',fld:'vID',pic:'ZZZZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         EvtRowId = "";
         sEvtType = "";
         AV8Filter = new GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter(context);
         AV15GXV1 = new GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication>( context, "GeneXus.Programs.genexussecurity.SdtGAMApplication", "GeneXus.Programs");
      ...
      private GXExternalCollection<GeneXus.Programs.genexussecurity.SdtGAMApplication> AV15GXV1 ;
      ...
      private GeneXus.Programs.genexussecurity.SdtGAMApplicationFilter AV8Filter ;
   }
