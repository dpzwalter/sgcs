/*
       ...
       Generated on: 8/23/2020 14:32:30.29
...
namespace GeneXus.Programs {
   public class wwproyecto : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13NombreProyecto, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202082314323031", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vNOMBREPROYECTO", StringUtil.RTrim( AV13NombreProyecto));
         /* Send saved values. */
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Proyectos", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWProyecto.htm");
            ...
            GxWebStd.gx_label_element( context, edtavNombreproyecto_Internalname, "Nombre Proyecto", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            GxWebStd.gx_single_line_edit( context, edtavNombreproyecto_Internalname, StringUtil.RTrim( AV13NombreProyecto), StringUtil.RTrim( context.localUtil.Format( AV13NombreProyecto, "")), TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "Nombre de Proyecto", edtavNombreproyecto_Jsonclick, 0, "FilterSearchAttribute", "", "", "", "", 1, edtavNombreproyecto_Enabled, 0, "text", "", 60, "chr", 1, "row", 60, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_WWProyecto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A11IdEstado), 4, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A12Estado));
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtEstado_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Proyectos", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Nombreproyecto Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vNOMBREPROYECTO"), AV13NombreProyecto) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0S2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavNombreproyecto_Internalname;
      ...
      protected void RF0S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV13NombreProyecto = StringUtil.PadR( StringUtil.RTrim( AV13NombreProyecto), 60, "%");
            /* Using cursor H000S2 */
            pr_default.execute(0, new Object[] {lV13NombreProyecto, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A3FechaCreacion = H000S2_A3FechaCreacion[0];
               A12Estado = H000S2_A12Estado[0];
               A11IdEstado = H000S2_A11IdEstado[0];
               A4DescripcionProyecto = H000S2_A4DescripcionProyecto[0];
               A2NombreProyecto = H000S2_A2NombreProyecto[0];
               A1IdProyecto = H000S2_A1IdProyecto[0];
               A12Estado = H000S2_A12Estado[0];
               E140S2 ();
      ...
      protected void send_integrity_lvl_hashes0S2( )
      {
         GxWebStd.gx_hidden_field( context, "vPGMNAME", StringUtil.RTrim( AV19Pgmname));
         GxWebStd.gx_hidden_field( context, "gxhash_vPGMNAME", GetSecureSignedToken( "", StringUtil.RTrim( context.localUtil.Format( AV19Pgmname, "")), context));
         GxWebStd.gx_hidden_field( context, "gxhash_IDPROYECTO"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A1IdProyecto), "ZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV13NombreProyecto = StringUtil.PadR( StringUtil.RTrim( AV13NombreProyecto), 60, "%");
         /* Using cursor H000S3 */
         pr_default.execute(1, new Object[] {lV13NombreProyecto});
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV13NombreProyecto = cgiGet( edtavNombreproyecto_Internalname);
            AssignAttri("", false, "AV13NombreProyecto", AV13NombreProyecto);
      ...
      private void E140S2( )
      {
         ...
         edtEstado_Link = formatLink("viewestado.aspx") + "?" + UrlEncode("" +A11IdEstado) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13NombreProyecto = ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value;
               AssignAttri("", false, "AV13NombreProyecto", AV13NombreProyecto);
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = AV13NombreProyecto;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202082314323051", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwproyecto.js", "?202082314323051", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtDescripcionProyecto_Internalname = "DESCRIPCIONPROYECTO_"+sGXsfl_25_idx;
         edtIdEstado_Internalname = "IDESTADO_"+sGXsfl_25_idx;
         edtEstado_Internalname = "ESTADO_"+sGXsfl_25_idx;
         edtFechaCreacion_Internalname = "FECHACREACION_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtDescripcionProyecto_Internalname = "DESCRIPCIONPROYECTO_"+sGXsfl_25_fel_idx;
         edtIdEstado_Internalname = "IDESTADO_"+sGXsfl_25_fel_idx;
         edtEstado_Internalname = "ESTADO_"+sGXsfl_25_fel_idx;
         edtFechaCreacion_Internalname = "FECHACREACION_"+sGXsfl_25_fel_idx;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavNombreproyecto_Internalname = "vNOMBREPROYECTO";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV13NombreProyecto',fld:'vNOMBREPROYECTO',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140S2',iparms:[{av:'A1IdProyecto',fld:'IDPROYECTO',pic:'ZZZ9',hsh:true},{av:'A11IdEstado',fld:'IDESTADO',pic:'ZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtNombreProyecto_Link',ctrl:'NOMBREPROYECTO',prop:'Link'},{av:'edtEstado_Link',ctrl:'ESTADO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110S2',iparms:[{av:'A1IdProyecto',fld:'IDPROYECTO',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13NombreProyecto',fld:'vNOMBREPROYECTO',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13NombreProyecto',fld:'vNOMBREPROYECTO',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13NombreProyecto',fld:'vNOMBREPROYECTO',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:'',hsh:true},{av:'AV13NombreProyecto',fld:'vNOMBREPROYECTO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13NombreProyecto = "";
         H000S2_A3FechaCreacion = new DateTime[] {DateTime.MinValue} ;
         H000S2_A12Estado = new String[] {""} ;
         H000S2_A11IdEstado = new short[1] ;
         H000S2_A4DescripcionProyecto = new String[] {""} ;
         H000S2_A2NombreProyecto = new String[] {""} ;
         H000S2_A1IdProyecto = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwproyecto__default(),
            new Object[][] {
                new Object[] {
               H000S2_A3FechaCreacion, H000S2_A12Estado, H000S2_A11IdEstado, H000S2_A4DescripcionProyecto, H000S2_A2NombreProyecto, H000S2_A1IdProyecto
               }
               , new Object[] {
      ...
      private int edtavNombreproyecto_Enabled ;
      ...
      private String AV13NombreProyecto ;
      ...
      private String edtavNombreproyecto_Internalname ;
      private String edtavNombreproyecto_Jsonclick ;
      ...
      private String lV13NombreProyecto ;
      ...
      private DateTime[] H000S2_A3FechaCreacion ;
      private String[] H000S2_A12Estado ;
      private short[] H000S2_A11IdEstado ;
      private String[] H000S2_A4DescripcionProyecto ;
      private String[] H000S2_A2NombreProyecto ;
      private short[] H000S2_A1IdProyecto ;
   ...
   public class wwproyecto__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             String A2NombreProyecto )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T1.[FechaCreacion], T2.[Estado], T1.[IdEstado], T1.[DescripcionProyecto], T1.[NombreProyecto], T1.[IdProyecto]";
         sFromString = " FROM ([Proyecto] T1 INNER JOIN [Estado] T2 ON T2.[IdEstado] = T1.[IdEstado])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13NombreProyecto)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[NombreProyecto] like @lV13NombreProyecto)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[NombreProyecto] like @lV13NombreProyecto)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[NombreProyecto]";
                                             ...
                                             String A2NombreProyecto )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ([Proyecto] T1 INNER JOIN [Estado] T2 ON T2.[IdEstado] = T1.[IdEstado])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV13NombreProyecto)) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@lV13NombreProyecto",SqlDbType.NChar,60,0} ,
