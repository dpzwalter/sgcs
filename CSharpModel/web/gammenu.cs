/*
       ...
       Generated on: 4/15/2020 11:2:13.88
...
namespace GeneXus.Programs {
   public class gammenu : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20204151121411", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("gammenu.aspx") +"\">") ;
      ...
      protected void RenderHtmlCloseForm2J2( )
      {
         ...
         {
            context.AddJavascriptSource("gammenu.js", "?20204151121427", false, true);
         }
      ...
      protected void S112( )
      {
         ...
         {
            AV5Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV6Errors.Item(AV12GXV1));
      ...
      protected void wb_table1_2_2J2( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            sStyleString = "";
            sStyleString = sStyleString + " width: " + StringUtil.LTrimStr( (decimal)(175), 10, 0) + "px" + ";";
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbusers_Internalname, "Users", "", "", lblTbusers_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e132j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:25px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbroles_Internalname, "Roles", "", "", lblTbroles_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e142j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:25px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbsecpol_Internalname, "Security Policies", "", "", lblTbsecpol_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e152j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:25px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbappl_Internalname, "Applications", "", "", lblTbappl_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e162j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:25px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbrepositoryconfiguration_Internalname, "Repository Configuration", "", "", lblTbrepositoryconfiguration_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e172j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:25px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbrepconn_Internalname, "Repository Connections", "", "", lblTbrepconn_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e182j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:25px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbauthtype_Internalname, "Authentication Types", "", "", lblTbauthtype_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e192j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td style=\""+CSSHelper.Prettify( "height:25px")+"\">") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbchgpassword_Internalname, "Change password", "", "", lblTbchgpassword_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e202j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td bgcolor=\"#F3F3F3\"  style=\""+CSSHelper.Prettify( "height:1px")+"\">") ;
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbchgrepository_Internalname, "Change Working Repository", "", "", lblTbchgrepository_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e212j1_client"+"'", "", "VerticalMenuOption", 7, "", 1, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            context.WriteHtmlText( "<td>") ;
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbrepositories_Internalname, "Repositories", "", "", lblTbrepositories_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e222j1_client"+"'", "", "VerticalMenuOption", 7, "", lblTbrepositories_Visible, 1, 0, "HLP_GAMMenu.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?20204151121596", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("gammenu.js", "?2020415112160", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'WWUSERS'","{handler:'E132J1',iparms:[]");
         setEventMetadata("'WWUSERS'",",oparms:[]}");
         setEventMetadata("'WWSECPOL'","{handler:'E152J1',iparms:[]");
         setEventMetadata("'WWSECPOL'",",oparms:[]}");
         setEventMetadata("'REPOSITORYCONFIGURATION'","{handler:'E172J1',iparms:[]");
         setEventMetadata("'REPOSITORYCONFIGURATION'",",oparms:[]}");
         setEventMetadata("'CHANGEPASSWORD'","{handler:'E202J1',iparms:[]");
         setEventMetadata("'CHANGEPASSWORD'",",oparms:[]}");
         setEventMetadata("'WWROLES'","{handler:'E142J1',iparms:[]");
         setEventMetadata("'WWROLES'",",oparms:[]}");
         setEventMetadata("'WWAPPLICATIONS'","{handler:'E162J1',iparms:[]");
         setEventMetadata("'WWAPPLICATIONS'",",oparms:[]}");
         setEventMetadata("'AUTHTYPE'","{handler:'E192J1',iparms:[]");
         setEventMetadata("'AUTHTYPE'",",oparms:[]}");
         setEventMetadata("'REPCONNECTION'","{handler:'E182J1',iparms:[]");
         setEventMetadata("'REPCONNECTION'",",oparms:[]}");
         setEventMetadata("'CHANGEWORKINGREPOSITORY'","{handler:'E212J1',iparms:[]");
         setEventMetadata("'CHANGEWORKINGREPOSITORY'",",oparms:[]}");
         setEventMetadata("'WWREPOSITORIES'","{handler:'E222J1',iparms:[]");
         setEventMetadata("'WWREPOSITORIES'",",oparms:[]}");
         return  ;
      }
