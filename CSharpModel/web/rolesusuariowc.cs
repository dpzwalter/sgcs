/*
       ...
       Generated on: 8/14/2020 18:45:53.20
...
namespace GeneXus.Programs {
   public class rolesusuariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202081418455322", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("rolesusuariowc.aspx") + "?" + UrlEncode("" +AV6RolId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm3B2( )
      {
         ...
         {
            context.AddJavascriptSource("rolesusuariowc.js", "?202081418455324", false, true);
         }
      ...
      protected void WB3B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            else
            {
               ...
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A32UsuID), 4, 0, ".", "")));
         ...
         if ( wbEnd == 20 )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtRolId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A40RolId), 4, 0, ".", "")), ((edtRolId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A40RolId), "ZZZ9")) : context.localUtil.Format( (decimal)(A40RolId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRolId_Jsonclick, 0, "Attribute", "", "", "", "", edtRolId_Visible, edtRolId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_RolesUsuarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              A32UsuID = (short)(context.localUtil.CToN( cgiGet( edtUsuID_Internalname), ".", ","));
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A32UsuID), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"USUID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A32UsuID), 4, 0, ".", "")));
      }
      ...
      protected void RF3B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40RolId = H003B2_A40RolId[0];
               AssignAttri(sPrefix, false, "A40RolId", StringUtil.LTrimStr( (decimal)(A40RolId), 4, 0));
               A37UsuCla = H003B2_A37UsuCla[0];
               A40000UsuImg_GXI = H003B2_A40000UsuImg_GXI[0];
               AssignProp(sPrefix, false, edtUsuImg_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A33UsuImg)) ? A40000UsuImg_GXI : context.convertURL( context.PathToRelativeUrl( A33UsuImg))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtUsuImg_Internalname, "SrcSet", context.GetImageSrcSet( A33UsuImg), true);
               A36UsuApe = H003B2_A36UsuApe[0];
               A35UsuNom = H003B2_A35UsuNom[0];
               A32UsuID = H003B2_A32UsuID[0];
               A33UsuImg = H003B2_A33UsuImg[0];
               AssignProp(sPrefix, false, edtUsuImg_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A33UsuImg)) ? A40000UsuImg_GXI : context.convertURL( context.PathToRelativeUrl( A33UsuImg))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtUsuImg_Internalname, "SrcSet", context.GetImageSrcSet( A33UsuImg), true);
               E133B2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_USUID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A32UsuID), "ZZZ9"), context));
      }
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("usuario.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A32UsuID);
         edtavDelete_Link = formatLink("usuario.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A32UsuID);
         edtUsuNom_Link = formatLink("viewusuario.aspx") + "?" + UrlEncode("" +A32UsuID) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 20;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202081418455349", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("rolesusuariowc.js", "?202081418455349", false, true);
         }
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtUsuID_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A32UsuID), 4, 0, ".", "")),context.localUtil.Format( (decimal)(A32UsuID), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtUsuID_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false,(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RolId',fld:'vROLID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E133B2',iparms:[{av:'A32UsuID',fld:'USUID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtUsuNom_Link',ctrl:'USUNOM',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E113B2',iparms:[{av:'A32UsuID',fld:'USUID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RolId',fld:'vROLID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RolId',fld:'vROLID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RolId',fld:'vROLID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6RolId',fld:'vROLID',pic:'ZZZ9'},{av:'AV11Update',fld:'vUPDATE',pic:''},{av:'AV12Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         A40000UsuImg_GXI = "";
         scmdbuf = "";
         H003B2_A40RolId = new short[1] ;
         H003B2_A37UsuCla = new String[] {""} ;
         H003B2_A40000UsuImg_GXI = new String[] {""} ;
         H003B2_A36UsuApe = new String[] {""} ;
         H003B2_A35UsuNom = new String[] {""} ;
         H003B2_A32UsuID = new short[1] ;
         H003B2_A33UsuImg = new String[] {""} ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.rolesusuariowc__default(),
            new Object[][] {
                new Object[] {
               H003B2_A40RolId, H003B2_A37UsuCla, H003B2_A40000UsuImg_GXI, H003B2_A36UsuApe, H003B2_A35UsuNom, H003B2_A32UsuID, H003B2_A33UsuImg
               }
               , new Object[] {
      ...
      private short[] H003B2_A40RolId ;
      private String[] H003B2_A37UsuCla ;
      private String[] H003B2_A40000UsuImg_GXI ;
      private String[] H003B2_A36UsuApe ;
      private String[] H003B2_A35UsuNom ;
      private short[] H003B2_A32UsuID ;
      private String[] H003B2_A33UsuImg ;
   ...
   public class rolesusuariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H003B2", "SELECT [RolId], [UsuCla], [UsuImg_GXI], [UsuApe], [UsuNom], [UsuID], [UsuImg] FROM [Usuario] WHERE [RolId] = @AV6RolId ORDER BY [RolId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003B2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003B3", "SELECT COUNT(*) FROM [Usuario] WHERE [RolId] = @AV6RolId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003B3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
