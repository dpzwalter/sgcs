...
using System.IO;
public class bldaloadeventssampleproc : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaloadeventssampleproc( ) : base()
   {
   }
   ...
   {
      bldaloadeventssampleproc x = new bldaloadeventssampleproc() ;
      x.SetMainSourceFile( "aloadeventssampleproc.cs");
