/*
       ...
       Generated on: 4/15/2020 11:5:14.98
...
namespace GeneXus.Programs {
   public class gamexamplelogin : GXHttpHandler, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?20204151151570", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB140( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbrememberme2_Internalname, "FORGOT YOUR PASSWORD?", "", "", lblTbrememberme2_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11141_client"+"'", "", "PagingText TextLikeLink", 7, "", 1, 1, 0, "HLP_GAMExampleLogin.htm");
            GxWebStd.gx_div_end( context, "Center", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "Center", "top", "", "", "div");
            wb_table1_50_142( true) ;
         }
         else
         {
            wb_table1_50_142( false) ;
         }
         return  ;
      }

      protected void wb_table1_50_142e( bool wbgen )
      {
         if ( wbgen )
         {
            GxWebStd.gx_div_end( context, "Center", "top", "div");
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                  {
                     ...
                     else
                     {
                        ...
                        if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 18), "GRIDAUTHTYPES.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 26), "'SELECTAUTHENTICATIONTYPE'") == 0 ) )
                        {
                           ...
                           AssignProp("", false, edtavImageauthtype_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( AV30ImageAuthType)) ? AV41Imageauthtype_GXI : context.convertURL( context.PathToRelativeUrl( AV30ImageAuthType))), !bGXsfl_63_Refreshing);
                           ...
                           AssignAttri("", false, "gxhash_vNAMEAUTHTYPE"+"_"+sGXsfl_63_idx, GetSecureSignedToken( sGXsfl_63_idx, StringUtil.RTrim( context.localUtil.Format( AV32NameAuthType, "")), context));
                           sEvtType = StringUtil.Right( sEvt, 1);
                           if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                           {
                              sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1));
      ...
      protected void E14142( )
      {
         ...
         if ( ! AV16isRedirect )
         {
            ...
            else
            {
               ...
               AV39GXV1 = 1;
               while ( AV39GXV1 <= AV9AuthenticationTypes.Count )
               {
                  AV8AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV9AuthenticationTypes.Item(AV39GXV1));
      ...
      private void E15142( )
      {
         ...
         AV40GXV2 = 1;
         while ( AV40GXV2 <= AV9AuthenticationTypes.Count )
         {
            AV8AuthenticationType = ((GeneXus.Programs.genexussecurity.SdtGAMAuthenticationTypeSimple)AV9AuthenticationTypes.Item(AV40GXV2));
            if ( ! AV8AuthenticationType.gxTpr_Needusername )
            {
               if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV8AuthenticationType.gxTpr_Smallimagename)) )
               {
                  ...
                  AV41Imageauthtype_GXI = GXDbFile.PathToUrl( AV8AuthenticationType.gxTpr_Smallimagename);
               }
               else
               {
                  AV30ImageAuthType = context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( ));
                  AssignAttri("", false, edtavImageauthtype_Internalname, AV30ImageAuthType);
                  AV41Imageauthtype_GXI = GXDbFile.PathToUrl( context.GetImagePath( "6cdd3e18-cc5b-44e0-bd22-3efaf48a6c40", "", context.GetTheme( )));
               }
      ...
      protected void E12142( )
      {
         ...
         if ( AV19LoginOK )
         {
            ...
            {
               if ( AV36GamUser.checkrole("Tareas") )
               {
      ...
      protected void S112( )
      {
         ...
         AV42GXV3 = 1;
         while ( AV42GXV3 <= AV12Errors.Count )
         {
            AV11Error = ((GeneXus.Programs.genexussecurity.SdtGAMError)AV12Errors.Item(AV42GXV3));
      ...
      protected void wb_table1_50_142( bool wbgen )
      {
         if ( wbgen )
         {
            /* Table start */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTbregister_Internalname, "create an account", "", "", lblTbregister_Jsonclick, "'"+""+"'"+",false,"+"'"+"e17141_client"+"'", "", "ActionText TextLikeLink", 7, "", 1, 1, 0, "HLP_GAMExampleLogin.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            /* End of table */
            context.WriteHtmlText( "</table>") ;
            wb_table1_50_142e( true) ;
         }
         else
         {
            wb_table1_50_142e( false) ;
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020415115409", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gamexamplelogin.js", "?20204151154014", false, true);
      ...
      protected void sendrow_632( )
      {
         ...
         /* Attribute/Variable Label */
         GridauthtypesRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(String)"",(String)"Image Auth Type",(String)"col-sm-3 Fixed30Label",(short)0,(bool)true});
         /* Active Bitmap Variable */
         TempTags = " " + ((edtavImageauthtype_Enabled!=0)&&(edtavImageauthtype_Visible!=0) ? " onfocus=\"gx.evt.onfocus(this, 68,'',false,'',63)\"" : " ");
         ClassString = "Fixed30";
         StyleString = "";
         AV30ImageAuthType_IsBlob = (bool)((String.IsNullOrEmpty(StringUtil.RTrim( AV30ImageAuthType))&&String.IsNullOrEmpty(StringUtil.RTrim( AV41Imageauthtype_GXI)))||!String.IsNullOrEmpty(StringUtil.RTrim( AV30ImageAuthType)));
         sImgUrl = (String.IsNullOrEmpty(StringUtil.RTrim( AV30ImageAuthType)) ? AV41Imageauthtype_GXI : context.PathToRelativeUrl( AV30ImageAuthType));
         ...
         GridauthtypesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(String)"",(short)1,(short)0,(String)"px",(short)0,(String)"px",(String)" gx-attribute",(String)"left",(String)"top",(String)"",(String)"",(String)"div"});
         /* Attribute/Variable Label */
         GridauthtypesRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(String)cmbavTypeauthtype_Internalname,(String)"Type Auth Type",(String)"col-sm-3 AttributeLabel",(short)0,(bool)true});
         ...
         GridauthtypesRow.AddColumnProperties("div_start", -1, isAjaxCallMode( ), new Object[] {(String)"",(short)1,(short)0,(String)"px",(short)0,(String)"px",(String)" gx-attribute",(String)"left",(String)"top",(String)"",(String)"",(String)"div"});
         /* Attribute/Variable Label */
         GridauthtypesRow.AddColumnProperties("html_label", -1, isAjaxCallMode( ), new Object[] {(String)edtavNameauthtype_Internalname,(String)"Name Auth Type",(String)"col-sm-3 AttributeLabel",(short)0,(bool)true});
         /* Single line edit */
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRIDAUTHTYPES.LOAD","{handler:'E15142',iparms:[{av:'divButtons_Visible',ctrl:'BUTTONS',prop:'Visible'},{av:'AV17KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV21RememberMe',fld:'vREMEMBERME',pic:''}]");
         ...
         setEventMetadata("'FORGOTPASSWORD'","{handler:'E11141',iparms:[{av:'AV6ApplicationClientId',fld:'vAPPLICATIONCLIENTID',pic:''},{av:'AV17KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV21RememberMe',fld:'vREMEMBERME',pic:''}]");
         ...
         setEventMetadata("'REGISTER'","{handler:'E17141',iparms:[{av:'AV17KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV21RememberMe',fld:'vREMEMBERME',pic:''}]");
         setEventMetadata("'REGISTER'",",oparms:[{av:'AV17KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV21RememberMe',fld:'vREMEMBERME',pic:''}]}");
         setEventMetadata("'SELECTAUTHENTICATIONTYPE'","{handler:'E16142',iparms:[{av:'AV32NameAuthType',fld:'vNAMEAUTHTYPE',pic:'',hsh:true},{av:'AV26UserName',fld:'vUSERNAME',pic:''},{av:'AV27UserPassword',fld:'vUSERPASSWORD',pic:''},{av:'AV17KeepMeLoggedIn',fld:'vKEEPMELOGGEDIN',pic:''},{av:'AV21RememberMe',fld:'vREMEMBERME',pic:''}]");
