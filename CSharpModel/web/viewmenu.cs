/*
       ...
       Generated on: 8/23/2020 14:32:30.49
...
namespace GeneXus.Programs {
   public class viewmenu : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewmenu( )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202082314323051", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewmenu.aspx") + "?" + UrlEncode("" +AV12MenuXid) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("MenuXDesc", StringUtil.RTrim( context.localUtil.Format( A28MenuXDesc, "")));
      ...
      {
         return formatLink("viewmenu.aspx") + "?" + UrlEncode("" +AV12MenuXid) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB2Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Menu Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewMenu.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Menus", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewMenu.htm");
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtMenuXDesc_Internalname, A28MenuXDesc, StringUtil.RTrim( context.localUtil.Format( A28MenuXDesc, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtMenuXDesc_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtMenuXDesc_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewMenu.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewMenu.htm");
            /* Div Control */
      ...
      protected void RF2Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A27MenuXid = H002Z2_A27MenuXid[0];
               A28MenuXDesc = H002Z2_A28MenuXDesc[0];
               n28MenuXDesc = H002Z2_n28MenuXDesc[0];
      ...
      protected void E112Z2( )
      {
         ...
         {
            A27MenuXid = H002Z3_A27MenuXid[0];
            A28MenuXDesc = H002Z3_A28MenuXDesc[0];
            n28MenuXDesc = H002Z3_n28MenuXDesc[0];
            AssignAttri("", false, "A28MenuXDesc", A28MenuXDesc);
            AV16GXLvl6 = 1;
            Form.Caption = A28MenuXDesc;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202082314323060", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewmenu.js", "?202082314323061", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12MenuXid',fld:'vMENUXID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A28MenuXDesc',fld:'MENUXDESC',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H002Z2_A27MenuXid = new short[1] ;
         H002Z2_A28MenuXDesc = new String[] {""} ;
         H002Z2_n28MenuXDesc = new bool[] {false} ;
         hsh = "";
         H002Z3_A27MenuXid = new short[1] ;
         H002Z3_A28MenuXDesc = new String[] {""} ;
         H002Z3_n28MenuXDesc = new bool[] {false} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewmenu__default(),
            new Object[][] {
                new Object[] {
               H002Z2_A27MenuXid, H002Z2_A28MenuXDesc, H002Z2_n28MenuXDesc
               }
               , new Object[] {
               H002Z3_A27MenuXid, H002Z3_A28MenuXDesc, H002Z3_n28MenuXDesc
               }
            }
         );
      ...
      private short[] H002Z2_A27MenuXid ;
      private String[] H002Z2_A28MenuXDesc ;
      private bool[] H002Z2_n28MenuXDesc ;
      private short[] H002Z3_A27MenuXid ;
      private String[] H002Z3_A28MenuXDesc ;
      private bool[] H002Z3_n28MenuXDesc ;
   ...
   public class viewmenu__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12MenuXid",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH002Z3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H002Z2", "SELECT [MenuXid], [MenuXDesc] FROM [Menu] WHERE [MenuXid] = @AV12MenuXid ORDER BY [MenuXid] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Z2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H002Z3", "SELECT [MenuXid], [MenuXDesc] FROM [Menu] WHERE [MenuXid] = @AV12MenuXid ORDER BY [MenuXid] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Z3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
