/*
       ...
       Generated on: 8/14/2020 18:45:56.44
...
namespace GeneXus.Programs {
   public class viewroles : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202081418455647", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void WB380( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtRolNom_Internalname, A39RolNom, StringUtil.RTrim( context.localUtil.Format( A39RolNom, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRolNom_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtRolNom_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewRoles.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void RF382( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40RolId = H00382_A40RolId[0];
               A39RolNom = H00382_A39RolNom[0];
      ...
      protected void E11382( )
      {
         ...
         {
            A40RolId = H00383_A40RolId[0];
            A39RolNom = H00383_A39RolNom[0];
            AssignAttri("", false, "A39RolNom", A39RolNom);
            AV16GXLvl6 = 1;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202081418455661", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewroles.js", "?202081418455662", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00382_A40RolId = new short[1] ;
         H00382_A39RolNom = new String[] {""} ;
         hsh = "";
         H00383_A40RolId = new short[1] ;
         H00383_A39RolNom = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewroles__default(),
            new Object[][] {
                new Object[] {
               H00382_A40RolId, H00382_A39RolNom
               }
               , new Object[] {
               H00383_A40RolId, H00383_A39RolNom
               }
            }
         );
      ...
      private short[] H00382_A40RolId ;
      private String[] H00382_A39RolNom ;
      private short[] H00383_A40RolId ;
      private String[] H00383_A39RolNom ;
   ...
   public class viewroles__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00382", "SELECT [RolId], [RolNom] FROM [Roles] WHERE [RolId] = @AV12RolId ORDER BY [RolId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00382,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H00383", "SELECT [RolId], [RolNom] FROM [Roles] WHERE [RolId] = @AV12RolId ORDER BY [RolId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00383,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
