/*
               File: ViewRol
        Description: View Rol
             Author: GeneXus C# Generator version 16_0_10-142546
       Generated on: 8/23/2020 14:32:30.68
...
namespace GeneXus.Programs {
   public class viewrol : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewrol( )
      {
      ...
      public viewrol( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12RolId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12RolId", StringUtil.LTrimStr( (decimal)(AV12RolId), 4, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vROLID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12RolId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202082314323070", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewrol.aspx") + "?" + UrlEncode("" +AV12RolId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewRol");
         forbiddenHiddens.Add("RolNom", StringUtil.RTrim( context.localUtil.Format( A39RolNom, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewrol:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vROLID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12RolId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vROLID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12RolId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewrol.aspx") + "?" + UrlEncode("" +AV12RolId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB3F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Rol Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewRol.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Rols", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewRol.htm");
            ...
            GxWebStd.gx_label_element( context, edtRolNom_Internalname, "Nom", "col-sm-3 ReadonlyAttributeLabel", 1, true, "");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtRolNom_Internalname, A39RolNom, StringUtil.RTrim( context.localUtil.Format( A39RolNom, "")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtRolNom_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtRolNom_Enabled, 0, "text", "", 40, "chr", 1, "row", 40, 0, 0, 0, 1, -1, -1, true, "", "left", true, "", "HLP_ViewRol.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewRol.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblUsuario_title_Internalname, "Usuario", "", "", lblUsuario_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewRol.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START3F2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Rol", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF3F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A40RolId = H003F2_A40RolId[0];
               A39RolNom = H003F2_A39RolNom[0];
      ...
      protected void STRUP3F0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12RolId = (short)(context.localUtil.CToN( cgiGet( "vROLID"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewrol:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E113F2( )
      {
         ...
         {
            A40RolId = H003F3_A40RolId[0];
            A39RolNom = H003F3_A39RolNom[0];
            AssignAttri("", false, "A39RolNom", A39RolNom);
            AV16GXLvl6 = 1;
            Form.Caption = A39RolNom;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwrol.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "RolGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "rolgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "RolGeneral";
               WebComp_Generalwc_Component = "RolGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12RolId});
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Usuariowc_Component), StringUtil.Lower( "RolUsuarioWC")) != 0 )
            {
               WebComp_Usuariowc = getWebComponent(GetType(), "GeneXus.Programs", "rolusuariowc", new Object[] {context} );
               WebComp_Usuariowc.ComponentInit();
               WebComp_Usuariowc.Name = "RolUsuarioWC";
               WebComp_Usuariowc_Component = "RolUsuarioWC";
            }
            if ( StringUtil.Len( WebComp_Usuariowc_Component) != 0 )
            {
               WebComp_Usuariowc.setjustcreated();
               WebComp_Usuariowc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12RolId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12RolId = Convert.ToInt16(getParm(obj,0));
         AssignAttri("", false, "AV12RolId", StringUtil.LTrimStr( (decimal)(AV12RolId), 4, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vROLID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12RolId), "ZZZ9"), context));
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewrol.js", "?202082314323082", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12RolId',fld:'vROLID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A39RolNom',fld:'ROLNOM',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H003F2_A40RolId = new short[1] ;
         H003F2_A39RolNom = new String[] {""} ;
         hsh = "";
         H003F3_A40RolId = new short[1] ;
         H003F3_A39RolNom = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewrol__default(),
            new Object[][] {
                new Object[] {
               H003F2_A40RolId, H003F2_A39RolNom
               }
               , new Object[] {
               H003F3_A40RolId, H003F3_A39RolNom
               }
            }
         );
      ...
      private short AV12RolId ;
      private short wcpOAV12RolId ;
      ...
      private short[] H003F2_A40RolId ;
      private String[] H003F2_A39RolNom ;
      private short[] H003F3_A40RolId ;
      private String[] H003F3_A39RolNom ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewrol__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12RolId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH003F3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H003F2", "SELECT [RolId], [RolNom] FROM [Rol] WHERE [RolId] = @AV12RolId ORDER BY [RolId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003F2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H003F3", "SELECT [RolId], [RolNom] FROM [Rol] WHERE [RolId] = @AV12RolId ORDER BY [RolId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003F3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
