/*
       ...
       Generated on: 8/18/2020 0:26:0.32
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeMenu( )
      {
         String cmdBuffer = "" ;
         /* Indices for table Menu */
         cmdBuffer=" ALTER TABLE [Menu] DROP COLUMN [Icon] "
         ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            MenuCount = P00012_AMenuCount[0];
            pr_default.close(0);
            PrintRecordCount ( "Menu" ,  MenuCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ! ColumnExist("Menu",sSchemaVar,"Icon") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_not_exist", new   object[]  {"Icon", "Menu"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeMenu" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"Menu", ""}) );
      }
      ...
      protected int[] P00012_AMenuCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [Menu] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100, GxCacheFrequency.OFF ,true,false )
