/*
       ...
       Generated on: 8/14/2020 18:45:56.63
...
namespace GeneXus.Programs {
   public class wwroles : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202081418455666", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RF392( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A39RolNom = H00392_A39RolNom[0];
               A40RolId = H00392_A40RolId[0];
               E14392 ();
      ...
      {
         /* Grid_Load Routine */
         edtavUpdate_Link = formatLink("roles.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode("" +A40RolId);
         edtavDelete_Link = formatLink("roles.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode("" +A40RolId);
         edtRolNom_Link = formatLink("viewroles.aspx") + "?" + UrlEncode("" +A40RolId) + "," + UrlEncode(StringUtil.RTrim(""));
         /* Load Method */
         if ( wbStart != -1 )
         {
            wbStart = 25;
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202081418455684", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwroles.js", "?202081418455684", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E14392',iparms:[{av:'A40RolId',fld:'ROLID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E11392',iparms:[{av:'A40RolId',fld:'ROLID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV13RolNom = "";
         H00392_A39RolNom = new String[] {""} ;
         H00392_A40RolId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwroles__default(),
            new Object[][] {
                new Object[] {
               H00392_A39RolNom, H00392_A40RolId
               }
               , new Object[] {
      ...
      private String[] H00392_A39RolNom ;
      private short[] H00392_A40RolId ;
   ...
   public class wwroles__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00392(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
               case 1 :
                     return conditional_H00393(context, (String)dynConstraints[0] , (String)dynConstraints[1] );
         }
